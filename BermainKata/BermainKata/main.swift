...
//  BermainKata
//
//  Created by Surya on 03/05/21.
//

import Foundation

print("Hello, mari bermain kata!")
print("--------------------")

// Mengambil inputan
print("Masukan nama depan anda:"); let firstName = String(readLine() ?? "")
print("Masukan nama belakang anda:"); let lastName = String(readLine() ?? "")
print("---------------------")
